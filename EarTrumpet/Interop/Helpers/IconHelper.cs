...
public class IconHelper
{
    ...
    public static Icon LoadIconFallback(string path, int iconOrdinal, int cx, int cy, bool forTaskbar)
    {
        try
        {
        ...
        {
            return LoadIconResource(path, iconOrdinal, cx, cy, forTaskbar);
        }
    }
